...
HD_PWD='C:/Users/44423-1/OneDrive/Escritorio/Vivado/proyFinal/proyFinal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clkSemaforo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clkSemaforo.tcl
