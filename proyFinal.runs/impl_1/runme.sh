...
HD_PWD='C:/Users/44423-1/OneDrive/Escritorio/Vivado/proyFinal/proyFinal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clkSemaforo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clkSemaforo.tcl -notrace
